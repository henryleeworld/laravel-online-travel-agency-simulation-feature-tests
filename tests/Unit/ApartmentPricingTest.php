...
class ApartmentPricingTest extends TestCase
{
    ...
    {
        $prices = collect([
            ['start_date' => '2026-05-01', 'end_date' => '2030-05-01', 'price' => 100]
        ]);
    ...
    {
        $prices = collect([
            ['start_date' => '2026-05-01', 'end_date' => '2026-05-10', 'price' => 100],
            ['start_date' => '2026-05-11', 'end_date' => '2026-06-01', 'price' => 90],
        ]);
