...
class PropertySearchTest extends TestCase
{
    ...
    public function test_search_shows_only_apartments_available_for_dates()
    {
        ...
        $response = $this->getJson('/api/v2/search?city=' . $cityId . '&adults=2&children=1&start_date=' . now()->addDay()->toDateString() . '&end_date=' . now()->addDays(2)->toDateString());
        $response->assertStatus(200);
        $response->assertJsonCount(2, 'properties.data');
        ...
        $response = $this->getJson('/api/v2/properties/' . $property2->id . '?city=' . $cityId . '&adults=2&children=1&start_date=' . now()->addDay()->toDateString() . '&end_date=' . now()->addDays(2)->toDateString());
        $response->assertStatus(200);
